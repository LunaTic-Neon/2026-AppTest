...
export default function LevelUpScreen() {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-slate-900 border-2 border-cyan-400 rounded-lg p-8 max-w-2xl w-full mx-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-cyan-400 mb-2">
            레벨 {playerStore.player.level}
          </h1>
          <p className="text-gray-300 text-lg">업그레이드를 선택하세요</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {availableUpgrades.map((upgrade) => (
            <button
              ...
              className="group relative bg-slate-800 border-2 border-gray-600 hover:border-cyan-400 rounded-lg p-6 transition-all duration-200 hover:shadow-lg hover:shadow-cyan-400/20"
            >
